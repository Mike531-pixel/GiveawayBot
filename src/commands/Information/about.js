    ...
    return await context.createMessage({
      ...
      embeds: [
        ...
        .setColor(guildData.embedColor)
          ...
          .setDescription(
            `Hello! I'm **GiveawayBot**, and I'm here to make it as easy as possible to hold giveaways on your Discord server! I was created by [random.js](https://discord.com/users/878975596623986700) (<@878975596623986700>). All of my commands star with \`/g\`. Don't forget to start this project at **https://github.com/ItzRandom23/GiveawayBot/**!`
          )
          .addFields({
            name: "📊 Stats",
